...
- [Viewer Components](#viewer-components)
  - [HttpRequestViewer](#httprequestviewer)
  - [IncludeStepViewer](#includestepviewer)
  - [BindStepViewer](#bindstepviewer)
...
Viewer components display step information in read-only format.

### HttpRequestViewer

Display HTTP request step details.
...
```tsx
<HttpRequestViewer step={step} />
```

#### Display Sections

- **Method & Path**: HTTP method chip + path
- **Headers**: List of header key-value pairs
- **Query Parameters**: List of query parameter key-value pairs
- **Request Body**: JSON/form/raw body display
- **Test Expression**: Test condition
- **Response Bindings**: Variables bound from response

---

### IncludeStepViewer

Display Include step details.
...
```tsx
<IncludeStepViewer step={step} />
```

#### Display Sections

- **Path**: File path to included runbook
- **Variables**: List of variables passed to included runbook (if any)

---

### BindStepViewer

Display Bind step details.
...
```tsx
<BindStepViewer step={step} />
```

#### Display Sections

- **Bindings**: List of variable bindings with JSON formatting for complex values
